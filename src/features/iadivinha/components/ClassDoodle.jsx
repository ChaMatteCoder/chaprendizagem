  ...
  return (
    <svg className="iad-doodle" viewBox="0 0 240 190" fill="none" stroke="currentColor" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false">
      {kind === 'cat' && <>
        ...
        <path stroke="#ff9368" strokeWidth="5" d="m59 43 2 24 14-6m96 0 10 5-1-25" />
        <path d="m28 109 38 3m-37 18 37-6m-25 23 29-12m105-25 36-5m-36 20 38 1m-42 10 31 13" />
        <ellipse fill="currentColor" stroke="none" cx="88" cy="99" rx="6" ry="8" /><ellipse fill="currentColor" stroke="none" cx="151" cy="98" rx="6" ry="8" />
      ...
      {kind === 'duck' && <>
        <path d="m99 151-6 20m6-5-13 3m58-18 7 18 14 1" />
        ...
        <path strokeWidth="6" d="M79 132q21 13 40-7" />
      </>}
      {kind === 'shoe' && <>
        ...
        <path d="M30 130Q73 158 214 123M173 139l1 22M80 93l17 17m1-34 16 19m1-35 16 20" />
      </>}
      {kind === 'bread' && <>
      ...
      {kind === 'hot-air-balloon' && <>
        ...
        <path d="M95 129h50m-50 0 8 20m17-20v20m25-20-8 20" /><path fill="#fff9e9" d="M99 149h42l-4 23q-17 9-34 0Z" />
        <path stroke="#2671d5" strokeWidth="6" d="m57 127-15-5m18 21-12 9m132-29 15-5m-13 22 12 9" />
      </>}
      {kind === 'airplane' && <>
        <path stroke="#258256" strokeWidth="6" d="m50 49-9-12m145 98 14 1m-23 15 10 12" />
      ...
      {kind === 'guitar' && <>
        ...
        <path strokeWidth="3" d="m81 142 83-110m-78 114 84-110m-79 114 84-110" /><path strokeWidth="8" d="m77 141 19 15" />
      </>}
    </svg>
  );
}
